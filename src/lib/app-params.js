...
const getAppParams = () => {
	...
	return {
		appId: getAppParamValue("app_id", { defaultValue: import.meta.env.VITE_PRIMEOS_APP_ID }),
		...
		appBaseUrl: getAppParamValue("app_base_url", { defaultValue: import.meta.env.VITE_PRIMEOS_APP_BASE_URL }),
	}
}
